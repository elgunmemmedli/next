...
} from "@/app/store/products/productsApi";
import Loading from "@/app/components/Loading";
import { useState } from "react";
import { useDispatch, useSelector } from "react-redux";
import { commonApi } from "@/app/store/products/productsSlice";
        ...
        <tbody>
          <tr>
            <td colSpan={6}>
              <div
                role="status"
                className="w-[100%] p-6  border border-gray-200 divide-y divide-gray-200 rounded shadow animate-pulse dark:divide-gray-700 md:p-6 dark:border-gray-700"
              >
        ...
        {productsArr.length >= 1 ? (
          productsArr.map((item, index) => (
            ...
            >
              ...
              <td className="px-6 py-4">{item[1].title}</td>
              <td className="px-6 py-4">{item[1].price}</td>
              <td className="px-6 py-4">{item[1].brand}</td>
              ...
              <td className="flex justify-evenly py-4">
                ...
                >
                  {request.isLoading && selectId === item[0] ? (
                    <Loading />
                  ) : (
                    "Delete"
                  )}
  ...
  return (
    <>
      <div className="h-screen  relative overflow-x-auto mt-8">
        <Table tableHead={tableHead}>{content}</Table>
      </div>
              ...
              <div className="relative w-auto  mx-auto max-w-2xl">
                <div className=" dark:bg-gray-800 border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                  ...
                  <div className="relative p-6 flex-auto">
                    <img
                      className="h-80 w-max mx-auto max-w-lg rounded-lg"
                      src={viewProducts.link}
                      alt=""
                    />
